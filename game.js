...
const CONCEPTS = {
  ...
  remit:        { name:'Remittances',             unit:'Unit 2', def:'Money transferred by migrants to origin families. Global remittances reached $905 billion in 2024 — nearly 3× total global foreign aid (World Bank Migration & Development Brief, 2025).' },
...
// ── COUNTRY DATA ────────────────────────────────────────────
const CTRY = {
  mexico:      { name:'Mexico',      code:'MX', type:'origin', lat:23.6,  lon:-102.5, region:'Central America', topoId:484, stat:'5.1M emigrants/yr (IOM 2025)', fact:'Largest source of US immigrants. Economic insecurity & cartel violence are primary push factors (IOM World Migration Report 2025).' },
  honduras:    { name:'Honduras',    code:'HN', type:'origin', lat:14.1,  lon:-86.2,  region:'Central America', topoId:340, stat:'1 in 7 Hondurans lives abroad (IOM 2025)', fact:'Northern Triangle: gang violence & drought-driven food insecurity push 300K+ annually northward.' },
  syria:       { name:'Syria',       code:'SY', type:'origin', lat:35.0,  lon:38.3,   region:'Middle East',     topoId:760, stat:'6.1M refugees abroad (UNHCR 2025)', fact:'Post-Assad transition (Dec 2024): first returns beginning, but 6.1M remain displaced — UNHCR Global Trends 2024, pub. 2025.' },
  nigeria:     { name:'Nigeria',     code:'NG', type:'origin', lat:9.1,   lon:8.7,    region:'West Africa',     topoId:566, stat:'2.1M in European diaspora (UN DESA 2024)', fact:'Brain drain: 80K+ doctors left since 1990. Boko Haram & economic instability drive emigration.' },
  venezuela:   { name:'Venezuela',   code:'VE', type:'origin', lat:7.5,   lon:-66.6,  region:'South America',   topoId:862, stat:'7.74M displaced (R4V 2025)', fact:'Largest displacement crisis in Western Hemisphere. ~25% of population fled hyperinflation & authoritarian rule (R4V Jan 2025).' },
  afghanistan: { name:'Afghanistan', code:'AF', type:'origin', lat:33.9,  lon:67.7,   region:'Central Asia',    topoId:4,   stat:'5.8M refugees abroad (UNHCR 2025)', fact:'Taliban rule since 2021. Women barred from education & work. 5.8M refugees recorded in UNHCR Global Trends 2024 (pub. 2025).' },
  usa:         { name:'USA',         code:'US', type:'dest',   lat:37.1,  lon:-98.5,  region:'North America',   topoId:840, stat:'51.0M foreign-born (15.5% — CPS 2025)', fact:'HDI: 0.927. World\'s #1 migration destination. 51M foreign-born recorded in US Census CPS, 2025.' },
  canada:      { name:'Canada',      code:'CA', type:'dest',   lat:58.0,  lon:-96.8,  region:'North America',   topoId:124, stat:'23% immigrant population (Stats Can 2025)', fact:'HDI: 0.939. Express Entry points system. Canada targets 395K–500K new permanent residents per year (IRCC 2025).' },
  germany:     { name:'Germany',     code:'DE', type:'dest',   lat:51.2,  lon:10.5,   region:'Western Europe',  topoId:276, stat:'16.4M immigrants (20% — Destatis 2025)', fact:'HDI: 0.945. Skilled Immigration Act (2024) opens new labour pathways. ~1M Ukrainian refugees integrated.' },
  sweden:      { name:'Sweden',      code:'SE', type:'dest',   lat:62.0,  lon:15.0,   region:'Northern Europe', topoId:752, stat:'20% foreign-born (SCB 2025)', fact:'HDI: 0.952. Sweden tightened asylum rules in 2024–25. Still among highest refugee resettlement per capita globally.' },
  australia:   { name:'Australia',   code:'AU', type:'dest',   lat:-25.0, lon:133.8,  region:'Oceania',         topoId:36,  stat:'31.5% born abroad (ABS 2025)', fact:'HDI: 0.946. Net overseas migration reached a record 518K in 2023. Points-based skilled visa system (ABS 2025).' },
  uae:         { name:'UAE',         code:'AE', type:'dest',   lat:23.4,  lon:53.8,   region:'Middle East',     topoId:784, stat:'89% expat workforce (GDRFA 2025)', fact:'HDI: 0.911. Golden Visa program (2022) offers 10-year residency. Zero pathway to citizenship — purely economic migration.' }
};
